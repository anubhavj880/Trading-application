...
import co.biz.gatecoin.sink.ES_Sink;
import co.biz.gatecoin.util.BestBidAskCalculator;
import co.biz.gatecoin.util.MidPointCalculator;

public class GatecoinToESMain {
	private final static Logger slf4jLogger = LoggerFactory.getLogger(GatecoinToESMain.class);
	...
	public static void main(String[] args) throws Exception {
    	...
    	try {
    		kafkaPropStream = GatecoinToESMain.class.getClassLoader().getResourceAsStream("kafka.properties");
    		esPropStream = GatecoinToESMain.class.getClassLoader().getResourceAsStream("es.properties");
...
//
		...
		env.execute("Gatecoin_Streaming_ES_App");
