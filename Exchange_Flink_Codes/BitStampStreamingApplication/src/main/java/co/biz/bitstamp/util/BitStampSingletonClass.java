 ...
 *
 */
public class BitStampSingletonClass {
	private final static Logger slf4jLogger = LoggerFactory.getLogger(BitStampSingletonClass.class);
	private static BitStampSingletonClass adlConnectionObj;
	...
	private BitStampSingletonClass() {

	}

	public static synchronized BitStampSingletonClass getInstance() throws IOException {
		if (adlConnectionObj == null) {
			adlConnectionObj = new BitStampSingletonClass();
		}
