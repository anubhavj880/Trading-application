...
import co.biz.quadrigacx.sink.ES_Sink;
import co.biz.quadrigacx.util.BestBidAskCalculator;
import co.biz.quadrigacx.util.MidPointCalculator;



public class QuadrigaCXToESMain 
{
	private final static Logger slf4jLogger = LoggerFactory.getLogger(QuadrigaCXToESMain.class);
	...
	public static void main(String[] args) throws Exception {
    	...
    	try {
    		kafkaPropStream = QuadrigaCXToESMain.class.getClassLoader().getResourceAsStream("kafka.properties");
    		esPropStream = QuadrigaCXToESMain.class.getClassLoader().getResourceAsStream("es.properties");
		...
		env.execute("QuadrigaCX_Streaming_App");
