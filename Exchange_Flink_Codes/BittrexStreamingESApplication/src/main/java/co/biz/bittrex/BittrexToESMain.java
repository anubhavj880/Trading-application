...
import co.biz.bittrex.sink.ES_Sink;
import co.biz.bittrex.util.BestBidAskCalculator;
import co.biz.bittrex.util.MidPointCalculator;

public class BittrexToESMain {
	private final static Logger slf4jLogger = LoggerFactory.getLogger(BittrexToESMain.class);
	...
	public static void main(String[] args) throws Exception {
    	...
    	try {
    		kafkaPropStream = BittrexToESMain.class.getClassLoader().getResourceAsStream("kafka.properties");
    		esPropStream = BittrexToESMain.class.getClassLoader().getResourceAsStream("es.properties");
...
//		//xrpbtc_TickerStream.addSink(ES_Sink.getESTickerSink()).setParallelism(3).name("XRPBTC_Ticker_ESSink");
		env.execute("Bitrex_Streaming_ES_App");
